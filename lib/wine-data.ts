...
export const wines: WineBottle[] = [
  {
    ...
    grapeVarieties: "Mourvedre, Grenache, Cinsault",
    style: "Red",
    bottleSize: "750ml",
    quantity: 4,
    purchasePrice: 68,
  ...
  },
  {
    ...
    grapeVarieties: "Tempranillo, Garnacha, Graciano, Mazuelo",
    style: "Red",
    bottleSize: "750ml",
    quantity: 3,
    purchasePrice: 57,
  ...
  },
  {
    ...
    country: "Portugal",
    grape: "Field Blend",
    grapeVarieties: "Touriga Nacional, Touriga Franca, Tinta Roriz, Field Blend",
    style: "Fortified",
    bottleSize: "750ml",
    quantity: 2,
    purchasePrice: 92,
